...
- User data lives in `~/Library/Application Support/Launcher/{aliases,usage,hidden}.json` plus `clipboard/` (`index.json` and `blobs/`); use temporary directories for persistence checks.
